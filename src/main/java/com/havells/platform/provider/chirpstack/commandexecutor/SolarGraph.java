...
public class SolarGraph extends Executor{
...
//	private RestTemplate restTemplate;
	...
	private Logger logger = LoggerFactory.getLogger(SolarGraph.class);
	...
	void execute(String data, String devEUI) {
		...
		try {
			System.out.println("SOLAR GRAPH "+deviceOperationURL +"  "+ entityReq);
