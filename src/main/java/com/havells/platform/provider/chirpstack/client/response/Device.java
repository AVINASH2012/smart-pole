...
import com.havells.platform.request.Location;
...
public class Device {
	...
	public Device(DeviceDetailsByDevEUI device, String lastSeenAt, long deviceStatusBattery, long deviceStatusMargin,
			Location location) {
		super();
		this.device = device;
