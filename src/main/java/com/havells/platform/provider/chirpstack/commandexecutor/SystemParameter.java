...
public class SystemParameter extends Executor{
...
//	private RestTemplate restTemplate;
	...
	private Logger logger = LoggerFactory.getLogger(SystemParameter.class);
	...
	void execute(String data, String devEUI) {
		...
		try {
			System.out.println("SYSTEM PARAMETER "+deviceOperationURL +"  "+ entityReq);
