...
public class DeviceRegistration {
	...
	public DeviceRegistration(String applicationID, String description, String devEUI, String deviceProfileID,
	...
	public String toString() {
		return "DeviceRequest [applicationID=" + applicationID + ", description=" + description + ", devEUI="
